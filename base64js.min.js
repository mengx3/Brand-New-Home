    ...
    return function() {
        ...
        "/": [function(a, b, c) {
            ...
            function f(a) {
                ...
                for (c = 0; c < n; c += 4) {
                    b = l[a.charCodeAt(c)] << 18 | l[a.charCodeAt(c + 1)] << 12 | l[a.charCodeAt(c + 2)] << 6 | l[a.charCodeAt(c + 3)];
                    j[k++] = 255 & b >> 16;
                    j[k++] = 255 & b >> 8;
                    j[k++] = 255 & b;
                }
                if (2 === h) {
                    b = l[a.charCodeAt(c)] << 2 | l[a.charCodeAt(c + 1)] >> 4;
                    j[k++] = 255 & b;
                } else if (1 === h) {
                    b = l[a.charCodeAt(c)] << 10 | l[a.charCodeAt(c + 1)] << 4 | l[a.charCodeAt(c + 2)] >> 2;
                    j[k++] = 255 & b >> 8;
                    j[k++] = 255 & b;
                }
                return j;
            ...
            function h(a, b, c) {
                for (var d, e = [], f = b; f < c; f += 3) {
                    d = (16711680 & a[f] << 16) + (65280 & a[f + 1] << 8) + (255 & a[f + 2]);
                    e.push(g(d));
                }
                return e.join("");
            }
